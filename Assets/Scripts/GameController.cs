...
public class GameController : MonoBehaviour
{
    ...
    public CanvasGroup winlostMenu;
    ...
    { 
        view.text = "You win!";
        audioPlay.PlayAudio(win);
        Utility.SetCanvasGroupEnabled(winlostMenu, true);
    ...
    void Start()
    {
        ...
        Utility.SetCanvasGroupEnabled(buttonPanel, false);
        Utility.SetCanvasGroupEnabled(winlostMenu, false);
